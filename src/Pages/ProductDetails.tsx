      ...
      <div className='bg-white shadow-xl rounded-2xl p-8 flex flex-col md:flex-row gap-20'>
        ...
        <div className='flex-1'>
          ...
          <div className='flex gap-4 mt-10'>
            ...
            <button className='bg-amber-400 px-8 py-3 rounded-lg text-lg font-semibold hover:bg-amber-500 duration-300'>
              Add To Cart
            </button>

            <button className='bg-black text-white px-8 py-3 rounded-lg text-lg font-semibold hover:opacity-90 duration-300'>
              Buy Now
            </button>
